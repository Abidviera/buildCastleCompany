 ...
 certifications = [
    {
      ...
      description: 'All our engineers are professionally qualified and licensed'
    },
    {
      icon: 'file-check',
  ...
  // Optional: Refresh AOS on route changes if needed
  ...
  getIconPath(iconName: string): string {
    const iconPaths: { [key: string]: string } = {
      'award': 'M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5z',
      'file-check': 'M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m3.75 9l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
      ...
      'trending-up': 'M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 0 1 5.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941',
  ...
  ngOnDestroy(): void {
    // Clean up AOS on component destroy
    if (this.isBrowser && this.aosInitialized) {
      import('aos').then(AOS => {
