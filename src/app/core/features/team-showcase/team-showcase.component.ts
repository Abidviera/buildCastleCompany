...
export class TeamShowcaseComponent  extends AosBaseComponent{
  ...
  teamMembers: TeamMember[] = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbmdpbmVlciUyMGNvbnN0cnVjdGlvbnxlbnwxfHx8fDE3MzM2NzYwOTB8MA&ixlib=rb-4.1.0&q=80&w=1080',
      description: 'Experienced civil engineers ensuring structural integrity and safety'
    },
    {
      name: 'Skilled Workers',
      role: 'Construction & Execution',
      image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjB3b3JrZXJ8ZW58MXx8fHwxNzMzNjc2MTAwfDA&ixlib=rb-4.1.0&q=80&w=1080',
      description: 'Professional craftsmen with years of hands-on experience'
    },
    {
      name: 'Design Architects',
      role: 'Interior & Exterior Design',
      image: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcmNoaXRlY3QlMjBkZXNpZ258ZW58MXx8fHwxNzMzNjc2MTEwfDA&ixlib=rb-4.1.0&q=80&w=1080',
      description: 'Creative designers transforming spaces into beautiful realities'
    },
    {
      name: 'Project Managers',
      role: 'Planning & Supervision',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9qZWN0JTIwbWFuYWdlcnxlbnwxfHx8fDE3MzM2NzYxMjB8MA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  expertise: ExpertiseItem[] = [
    ...
    },
    {
      ...
      description: 'From planning to handover, we handle everything under one roof'
    },
    {
      icon: 'graph-up-arrow',
      iconClass: 'bi bi-graph-up-arrow',
      title: 'Continuous Innovation',
      description: 'We stay updated with latest construction technologies and trends'
    }
  ];

  // Bootstrap icon mapping (for dynamic cases if needed)
