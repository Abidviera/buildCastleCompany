...
export class BeforeAfterComponent extends AosBaseComponent {
  projects: Project[] = [
    {
      title: 'Complete Home Renovation',
      location: 'Kallumpuram',
      before:
        'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbGQlMjBob3VzZSUyMGludGVyaW9yfGVufDF8fHx8MTc2NDk2MTgyNnww&ixlib=rb-4.1.0&q=80&w=1080',
      after:
      ...
      description:
        'Transformed a 25-year-old house into a modern, luxurious home with contemporary design and premium finishes.',
    },
    {
      title: 'Kitchen Modernization',
      location: 'Kallumpuram',
      before:
        'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbGQlMjBraXRjaGVufGVufDF8fHx8MTc2NDk2MTgyNnww&ixlib=rb-4.1.0&q=80&w=1080',
      after:
      ...
      description:
        'Complete kitchen renovation with modular cabinets, modern appliances, and efficient storage solutions.',
    },
    {
      title: 'Exterior Transformation',
      location: 'Kallumpuram',
      before:
        'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbGQlMjBob3VzZSUyMGV4dGVyaW9yfGVufDF8fHx8MTc2NDk2MTgyN3ww&ixlib=rb-4.1.0&q=80&w=1080',
      after:
      ...
      description:
        'Dramatic exterior makeover with contemporary facade, new textures, and landscape integration.',
    },
  ];
