...
export class FaqComponent implements AfterViewInit, OnDestroy {
  ...
  private async initializeAOS(): Promise<void> {
    try {
      ...
      AOS.default.init({
        ...
        // Animation offset (when element triggers)
        offset: 100,
        ...
        // Don't mirror animation on scroll up
        mirror: false,
        ...
        // Start animation when element is 20% in viewport
  ...
  private handleScroll(): void {
    ...
    if (now - this.lastCall >= 100) {
      ...
      // (You had servicesVisible and qualityVisible logic in the original)
      // Example:
